...
#define FREE_CACHE_MEM(e)\
        do {\
                ...
                (e)->rar_p = NULL;\
                (e)->file_p = NULL;\
                /* EP004 Phase 0.5: Free nested metadata fields */ \
                free((e)->parent_rar_p);\
                (e)->parent_rar_p = NULL;\
        } while(0)
...
struct filecache_entry *filecache_clone(const struct filecache_entry *src)
{
        ...
        if (dest != NULL) {
                ...
                /* EP004 Phase 0.5: Clone nested metadata fields */
                if (src->parent_rar_p)
                   ...
                   struct filecache_entry *dest)
{
        ...
        /* EP004 Phase 0.5: Copy nested metadata fields (string fields already handled above) */
